...
def generate_key_pair() -> CryptoKeypair:
    ...
    Returns:
        :class:`~transactions.common.crypto.CryptoKeypair`: A
        :obj:`collections.namedtuple` with named fields
        :attr:`~transactions.common.crypto.CryptoKeypair.private_key` and
        :attr:`~transactions.common.crypto.CryptoKeypair.public_key`.
